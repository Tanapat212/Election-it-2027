...
export default function OverlayPage() {
  ...
  const sceneMap = {
    ...
    final_results: <FinalResultsScene results={results} candidatesMeta={candidatesMeta} eventTitle={eventTitle} />,
    winner_announcement: <WinnerAnnouncementScene results={results} candidatesMeta={candidatesMeta} eventTitle={eventTitle} />,
    blank: <BlankScene />,
  };
